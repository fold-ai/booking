...
struct SupabaseService {
  ...
  /// Перевірити чи є для поточного юзера pending invitations.
  /// Якщо є — UI може показати "You've been invited to <business>" і кнопку Accept.
  ...
  /// Прийняти invitation за токеном.
  /// Створить worker рядок і повʼяже з business.
  /// Після успіху варто перевикликати detectRole() щоб AppState оновився.
...
/// Результат accept_invitation RPC виклику.
