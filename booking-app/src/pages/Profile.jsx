    ...
    <div className="max-w-4xl space-y-8">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-ink-500">How you show up in the Fieldbase directory.</p>
        </div>
      ...
      <section className="card p-6">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            />
            {form.heroImageUrl && (
              <div className="mt-2 h-24 overflow-hidden rounded-xl bg-ink-100">
                <img src={form.heroImageUrl} alt="" className="h-full w-full object-cover" onError={(e) => { e.currentTarget.style.display = 'none' }} />
              </div>
            )}
          </div>
          <div>
            <label className="label">Logo / avatar URL</label>
            <input
              className="input"
            ...
            />
            {form.avatarUrl && (
              <div className="mt-2 h-24 w-24 overflow-hidden rounded-xl bg-ink-100">
                <img src={form.avatarUrl} alt="" className="h-full w-full object-cover" onError={(e) => { e.currentTarget.style.display = 'none' }} />
              </div>
            )}
          </div>
          <div>
