...
export default function Signup() {
  ...
  // ---------- Final submit ----------
  const submit = async () => {
    if (busy) return  // захист від double-click
    ...
    try {
      ...
      // HARD reload — повністю перезавантажує сторінку щоб BusinessContext
      // переініціалізувався з чистого state з вже створеним бізнесом.
      // Soft nav через React Router залишає старий context що не бачить новий бізнес.
