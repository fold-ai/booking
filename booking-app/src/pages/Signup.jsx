  ...
  return (
    <AuthShell title="Create your workspace" subtitle="Two minutes. We'll preload services for your trade.">
      <div className="space-y-4">
        <GoogleSignInButton label="Sign up with Google" disabled={busy} />

        <div className="rounded-xl bg-ink-50 px-3 py-2 text-xs text-ink-500">
          After signing in with Google, you'll set up your business on the next screen.
        </div>

        <div className="relative flex items-center py-1">
          <div className="flex-grow border-t border-ink-100" />
          <span className="mx-3 text-xs uppercase tracking-widest text-ink-400">or sign up with email</span>
          <div className="flex-grow border-t border-ink-100" />
        </div>
