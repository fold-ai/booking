    ...
    <div className="min-h-screen bg-ink-50">
      <header className="border-b border-ink-100 bg-white">
        <div className="mx-auto flex max-w-3xl items-center justify-between px-6 py-5">
          <div className="flex items-center gap-3">
            <div className="grid h-10 w-10 place-items-center rounded-xl bg-ink-800 text-amber font-bold">{(business?.name || 'F')[0]}</div>
            <div>
              <div className="font-display text-xl text-ink-800">{business?.name}</div>
              <div className="text-xs text-ink-400">{business?.city}</div>
            </div>
          </div>
          <div className="text-xs text-ink-400">Powered by Fieldbase</div>
        </div>
      </header>
