  ...
  return (
    <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
      ...
      <nav className="flex items-center gap-2 text-sm">
        <Link to="/" className="rounded-full bg-ink-800 px-4 py-1.5 text-ink-50">For customers</Link>
        <Link to="/for-business" className="rounded-full px-4 py-1.5 text-ink-500 hover:text-ink-800">For businesses</Link>
...
function Hero({ q, setQ, city, setCity, cities }) {
  return (
    <section className="grain relative mx-auto max-w-6xl px-6 pt-8 sm:pt-12">
      <div className="text-center">
        <div className="chip mx-auto"><Sparkles size={12} className="text-amber-deep" /> Vetted local pros</div>
        <h1 className="mt-4 font-display text-5xl leading-[1.05] tracking-tight text-ink-800 sm:text-7xl">
      ...
      <div className="mx-auto mt-8 flex max-w-3xl flex-col gap-2 rounded-2xl bg-white p-2 shadow-card sm:flex-row sm:items-center sm:rounded-full">
