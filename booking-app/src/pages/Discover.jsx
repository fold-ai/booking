  ...
  return (
    <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
      ...
      <nav className="flex items-center gap-2 text-sm">
        <Link to="/discover" className="rounded-full bg-ink-800 px-4 py-1.5 text-ink-50">For customers</Link>
        <Link to="/" className="rounded-full px-4 py-1.5 text-ink-500 hover:text-ink-800">For businesses</Link>
