...
import { LayoutDashboard, Calendar, ClipboardList, Users, UserCircle2, Wrench, Settings as Cog, Sparkles } from 'lucide-react'
  ...
  return (
    <aside className="hidden w-64 shrink-0 flex-col bg-ink-800 text-ink-100 md:flex">
      <div className="flex items-center gap-3 px-6 py-6">
        <div className="grid h-9 w-9 place-items-center rounded-xl bg-amber text-ink-800 font-bold">F</div>
        <div>
          <div className="text-sm font-semibold text-ink-50">Fieldbase</div>
