 ...
 * Два сценарії:
 *   1. Він був запрошений (є pending invitation) → показуємо великий блок з invitation
 *   2. Він новий і хоче створити свій бізнес → показуємо button "Set up my business" що веде на /signup wizard
 */
